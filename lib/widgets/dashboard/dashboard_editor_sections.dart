      ...
      child: Column(
        children: [
          _buildSimpleCard(
            ...
            child: Column(
              children: [
                for (int i = 0; i < widget.course.objectives.length; i++) _buildObjectiveRow(i),
                Align(
...
Widget _buildModulesRootSection() {
  return _wrapWithRepaint(
    SingleChildScrollView(
      ...
      child: Column(
        children: [
          _buildSimpleCard(title: "Gestión del temario", child: _buildModulesManagerRoot()),
          Consumer(
      ...
      child: Column(
        children: [
          _buildSimpleCard(
            ...
            child: Column(
              children: [
                for (int i = 0; i < widget.course.glossaryItems.length; i++) _buildGlossaryRow(i),
                Align(
                  alignment: Alignment.centerLeft,
                  child: TextButton.icon(
                    onPressed: () {
      ...
      child: Column(
        children: [
          _buildSimpleCard(
            ...
            child: Column(
              children: [
                for (int i = 0; i < widget.course.faqItems.length; i++) _buildFaqRow(i),
                Align(
                  alignment: Alignment.centerLeft,
                  child: TextButton.icon(
                    onPressed: () {
      ...
      children: [
        Expanded(
          child: TextFormField(
            ...
            onChanged: (value) => _scheduleDebouncedCourseUpdate('objective_$index', () {
    ...
    child: Column(
      children: [
        Row(
          children: [
            ...
            child: TextFormField(
              ...
              onChanged: (value) => _scheduleDebouncedCourseUpdate('glossary_term_$index', () {
                item.term = value;
              }),
            ),
            ),
        ...
        TextFormField(
          ...
          maxLines: 2,
          onChanged: (value) => _scheduleDebouncedCourseUpdate('glossary_def_$index', () {
    ...
    child: Column(
      children: [
        Row(
          children: [
            ...
            child: TextFormField(
              ...
              onChanged: (value) => _scheduleDebouncedCourseUpdate('faq_question_$index', () {
                item.question = value;
              }),
            ),
            ),
        ...
        TextFormField(
          ...
          maxLines: 2,
          onChanged: (value) => _scheduleDebouncedCourseUpdate('faq_answer_$index', () {
            item.answer = value;
          }),
        ),
      ],
